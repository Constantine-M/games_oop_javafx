...
/**
 * Класс enum - это обычный класс, но у него ограниченное количество объектов.
 * Все эти объекты прописываются внутри класса.
 * При этом объект этого класса создать нельзя.
 */
public enum Cell {
    ...
    /**
     * Метод values()  - это встроенный метод доступный у enum типов.
     * Он возвращает массив всех объектов этого перечисления.
     */
